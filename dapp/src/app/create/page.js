...
export default function Home() {
    ...
    function btnSaveClick(){
        ...
        openRequest(request)
            .then(result =>{
                alert("Pedido enviado com sucessso");
                ...
                <div className="ps-5">
                    ...
                    <div className="row">
                        <div className="col-1 mb-3">
                            <a href="/" className="btn btn-outline-dark col-12">Voltar</a>
                        </div>
                        <div className="col-5 mb-3 p-0">
                            <button type="button" className="btn btn-dark col-12" onClick={btnSaveClick}>Enviar Pedido</button>
                        </div>
                    </div>
                </div>
